...
export default async function AdminPaymentsPage() {
  ...
  return (
    <div className="grid gap-6">
      <PageHeader
        title="Payments"
        description="Checkout history for this parlor. Each charge used this shop’s Stripe secret key."
      />
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            {payments.length === 0 ? "No checkouts yet." : `${payments.length} most recent rows`}
          </CardDescription>
        </CardHeader>
        <CardContent>
          {payments.length === 0 ? (
